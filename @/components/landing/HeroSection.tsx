...
const stats = [
  { id: 1, name: 'Companies', value: '500+' },
  { id: 2, name: 'Equipment Managed', value: '50k+' },
  { id: 3, name: 'Uptime', value: '99.9%' },
  { id: 4, name: 'Cost Savings', value: '35%' },
];
      ...
      <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
          ...
          <h1 className="mt-10 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            Optimize Your Equipment Management
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Transform your maintenance operations with AI-powered insights, real-time monitoring, 
            and predictive analytics. Reduce downtime, extend equipment life, and cut costs.
          </p>
